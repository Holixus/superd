...
ifndef DEBUG
PACKET_CFLAGS  ?= -std=gnu99 -Os -Werror -ffast-math -fmerge-all-constants -ffunction-sections -fdata-sections -fomit-frame-pointer -fno-unwind-tables -fno-asynchronous-unwind-tables -fmerge-all-constants -fno-ident
PACKET_LDFLAGS ?= -Wl,--gc-sections -Wl,-z,norelro -Wl,--build-id=none
# -z max-page-size=0x10
#BIN_CFLAGS ?= -fwhole-program
else
